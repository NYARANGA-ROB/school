...
Your application was unfortunately rejected.
			<?php break; ?>
		<?php case ('user action required'): ?>
Your action is currently required, if you don't see the reason why contact the school for support.
			<?php break; ?>
		<?php default: ?>
This email has been sent to you because your application status has changed to <?php echo e($status); ?>.
	<?php endswitch; ?>
	<br>
	<br>
	<?php if(isset($reason)): ?>
Reason/Message -  <?php echo e($reason); ?> 
	<?php endif; ?>
	<?php if (isset($component)) { $__componentOriginal15a5e11357468b3880ae1300c3be6c4f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal15a5e11357468b3880ae1300c3be6c4f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => $__env->getContainer()->make(Illuminate\View\Factory::class)->make('mail::button'),'data' => ['url' => ''.e(route('dashboard')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('dashboard')).'']); ?>
	Log in
...
<?php endif; ?>
<?php /**PATH /home/schrodingercat/Desktop/schoolManagement/skuul/resources/views/emails/account-application/status-changed.blade.php ENDPATH**/ ?>