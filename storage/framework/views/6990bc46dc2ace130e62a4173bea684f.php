...
<?php $component = App\View\Components\Select::resolve(['id' => 'my_class','label' => 'Select a class to see timetable','groupClass' => 'my-6 md:w-1/2','name' => ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
[$__name, $__params] = $__split('datatable', ['model' => App\Models\MyClass::class,'filters' => [
...
</div><?php /**PATH /home/schrodingercat/Desktop/schoolManagement/skuul/resources/views/livewire/list-timetables-table.blade.php ENDPATH**/ ?>