...
<?php $component->withAttributes([]); ?>
        <form action="<?php echo e(route('login')); ?>" method="POST" class="px-3 md:p-5 w-full border-b-2">
...
<?php $component = App\View\Components\Input::resolve(['name' => 'email','id' => 'email','label' => 'Email'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal786b6632e4e03cdf0a10e8880993f28a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal786b6632e4e03cdf0a10e8880993f28a = $attributes; } ?>
<?php $component = App\View\Components\Input::resolve(['name' => 'password','id' => 'password','label' => 'Password'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Input::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Button::resolve(['class' => 'my-3 px-6 md:px-10 w-full'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="py-6">
            <p>Dont Have An account? <a href="<?php echo e(route('register')); ?>" class="text-blue-800" aria-label="Register"> Create Account</a></p>
        </div>
         <?php $__env->slot('footer', null, []); ?> 
            <a href="<?php echo e(route('password.request')); ?>" class="text-blue-800" aria-label="Forgot Password">Forgot your Password?</a>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/schrodingercat/Desktop/schoolManagement/skuul/resources/views/auth/login.blade.php ENDPATH**/ ?>