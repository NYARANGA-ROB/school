...
<?php endif; ?>
        ...
        <form wire:submit="tabulate('<?php echo e($class); ?>','<?php echo e($section); ?>')" class="d-md-flex my-3">
...
<?php $component = App\View\Components\Select::resolve(['id' => 'class','name' => 'class','label' => 'Class'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button::resolve(['label' => 'View records','class' => 'w-full md:w-1/4'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($createdTabulation === true): ?>
            <?php
...
<?php unset($__componentOriginale67687e3e4e61f963b25a6bcf3983629); ?>
<?php endif; ?>
        <?php elseif($createdTabulation === false): ?>
...
<?php /**PATH /home/schrodingercat/Desktop/schoolManagement/skuul/resources/views/livewire/semester-result-tabulation.blade.php ENDPATH**/ ?>